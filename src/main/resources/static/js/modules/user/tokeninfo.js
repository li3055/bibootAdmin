$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '', name: 'symbol', index: 'symbol', width: 60 },
			{ label: '', name: 'totalApply', index: 'total_apply', width: 100 ,formatter: "number", formatoptions: {thousandsSeparator:",", defaulValue:"",decimalPlaces:0}},
			...
			{ label: '', name: 'pre250Percent', index: 'pre_250_percent', width: 80 },
			{ label: '', name: 'pre300Percent', index: 'pre_300_percent', width: 80 },
            ...
            { label: '', name: 'pre250D1', index: 'pre_250_d1', width: 80 },
            { label: '', name: 'pre300D1', index: 'pre_300_d1', width: 80 },
	...
	methods: {
		...
		reload: function (event) {
			...
			$("#jqGrid").jqGrid('setGridParam',{
                postData:{'symbol': vm.q.symbol,'symbol':vm.q.symbol},
                page:page
            }).trigger("reloadGrid");
		}
	}
